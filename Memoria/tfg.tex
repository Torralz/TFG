...
\bibauthor{}
\director{} %TODO añadir el director
...
Es cierto que existen alternativas, como poder hablar y que se transcriba el texto. Sin embargo, no es una solución suficientemente buena para todos los casos. Por ejemplo, si se está trabajando en una oficina, no creo que hablar en alto sea una solución, porque podrías molestar a la gente alrededor de ti. También puede ocurrir si estás haciendo tu TFG en una biblioteca. En estas situaciones no se puede estar hablando.
